...
// macOS writes AppleDouble files ("._<filename>") on filesystems that do not
// support its native metadata, such as exFAT and many NAS shares. They are
// filesystem metadata sidecars, not user media, and their bytes may be
// regenerated by the destination filesystem.
...
// Skips the sentinel, internal dot-files, and AppleDouble metadata sidecars.
// ──────────────────────────────────────────────────────────────────────────
function listAllFiles(root, currentVersion) {
  ...
  function walk(dir, relBase) {
    ...
    for (const ent of entries) {
      ...
      if (isAppleDoubleFile(name)) continue;
...
module.exports = { inspectCard, appendIngest, listAllFiles, isWritable, readSentinel, SENTINEL_NAME, isAppleDoubleFile };
